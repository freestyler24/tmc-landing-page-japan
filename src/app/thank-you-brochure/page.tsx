        ...
        <main className="min-h-screen bg-[#111111] text-gray-300 py-16 md:py-24 px-4 font-sans selection:bg-primary-red/30">
            <div className="max-w-3xl mx-auto space-y-16">
                ...
                <section className="text-center space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-[#B89B5E] font-serif italic pt-4">
                ...
                <section className="grid md:grid-cols-2 gap-12 md:gap-8">
                    ...
                    <div className="bg-[#181818] p-8 md:p-10 border border-gray-800 rounded-sm shadow-xl relative group">
                        ...
                        <h2 className="text-2xl font-serif text-[#F5F3EF] mb-4">The Orientation.</h2>
                    ...
                    <div className="bg-[#181818] p-8 md:p-10 border border-gray-800 rounded-sm shadow-xl relative group flex flex-col justify-between">
                        <div className="absolute inset-1 border border-primary-red/10 rounded-sm pointer-events-none"></div>

                        <div className="mb-8">
                            <h2 className="text-xl font-serif text-[#F5F3EF] mb-3">Secure Your Orientation Seat</h2>
                            <p className="text-gray-400 leading-relaxed text-[14px]">
                                No obligation.
                                <br />
                                <span className="text-[#B89B5E] italic font-serif">Enrolment decisions are made only after the session.</span>
                            </p>
                            <a
                                href="/#register"
                                className="inline-block mt-4 bg-primary-red text-[#F5F3EF] px-6 py-3 rounded-sm text-[12px] font-semibold uppercase tracking-[0.1em] hover:bg-[#8b1c1c] transition-colors shadow-lg"
                            >
                                Register Now
                            </a>
                        </div>
                        ...
                        <div className="pt-6 border-t border-gray-800">
                            ...
                            <a
                                ...
                                className="inline-block bg-transparent border border-gray-600 text-[#F5F3EF] px-6 py-2 rounded-sm text-[12px] font-semibold uppercase tracking-[0.1em] hover:bg-gray-800 transition-colors"
                            >
                                Download Overview
                            </a>
                        </div>
                ...
                <section className="text-center space-y-10">
                    <div className="space-y-3">
                        ...
                        <p className="text-gray-400"><a href="tel:+919900786677" className="hover:text-white hover:underline">9900786677</a> | <a href="tel:+919886753632" className="hover:text-white hover:underline">9886753632</a></p>
                    </div>
...
export default function ThankYouBrochure() {
    return (
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#111111] text-primary-red uppercase tracking-widest text-sm">Loading...</div>}>
            <ThankYouContent />
        </Suspense>
    );
}
