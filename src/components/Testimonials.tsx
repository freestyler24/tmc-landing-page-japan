    ...
    return (
        <section className="bg-rice-white ma-spacing-mob ma-spacing-desk relative overflow-hidden">
            <div className="container-max relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-serif text-text-primary mb-4 md:mb-6">
                    ...
                    {testimonials.map((t, i) => {
                        ...
                        return (
                            <motion.div
                                variants={itemVariants}
                                key={i}
                                className={`relative bg-white border border-border-soft p-6 md:p-8 flex flex-col justify-between shadow-md hover:shadow-lg transition-all cursor-default ${rotations[i % 3]}`}
                            >
