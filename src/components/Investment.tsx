        ...
        <section id="investment" className="bg-alt-red ma-spacing-mob ma-spacing-desk relative text-offwhite overflow-hidden">
            <div className="container-max max-w-5xl">
                ...
                >
                    {[
                        ...
                        <motion.div
                            variants={fadeUp}
                            key={inst.num}
                            className="bg-[#F5F3EF] text-charcoal rounded-sm shadow-lg overflow-hidden border border-[#e6dac3] hover:shadow-xl transition-shadow transform hover:-translate-y-1 duration-300"
                        >
                            {/* Red top accent bar */}
                ...
                <motion.div
                    ...
                    className="bg-[#F5F3EF] text-charcoal shadow-2xl overflow-hidden border border-[#e6dac3]"
                >
